# bg forest_deer и cg deer_jumpscare зарегистрированы в scripts/assets.rpy
# (видео webm и mp4) — прежние текстовые моки удалены
...
label prologue:
    ...
    # Живой дождь на дороге (видео-фон, оленя нет)
    scene bg forest_no_deer
    with Dissolve(2.0)
    ...
    # [sfx_radio НЕСКОЛЬКО РАЗ — звук в ведомстве саунд-дизайнера]
